...
class Predictor:
    ...
    def predict_spans_unilabel(self, model_out):
        ...
        #Get the indices for the positive cases in preds as we only need these for the eval
    ...
    def predict_rels_unilabel(self, model_out, span_preds):
        ...
        #extract the indices for the positive preds only as these are required for eval
    ...
    def predict_rels_multilabel(self, model_out, span_preds):
        ...
        #Get the indices for the pos preds only as these are required for eval
    ...
    def predict_rels_unilabel_old(self, model_out, span_preds):
        '''
    ...
    def predict_rels_multilabel_old(self, model_out, span_preds):
        rel_logits = model_out['logits_rel']
        rel_ids    = model_out['cand_rel_ids']
        span_ids   = model_out['cand_w_span_ids']
