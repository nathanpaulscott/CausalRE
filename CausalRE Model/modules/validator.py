...
class Validator:
    ...
    def validate(self):
        ...
        if ((self.config.span_types is None or not isinstance(self.config.span_types, list) or len(self.config.span_types) == 0) or
            (self.config.rel_types is None or not isinstance(self.config.rel_types, list) or len(self.config.rel_types) == 0)):
        ...
        if 'none' in self.config.span_types or 'none' in self.config.rel_types:
